 ...
 */
final class Version20221102221859 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "selectedProduct" (id UUID NOT NULL, meal_id UUID NOT NULL, food_product_id UUID NOT NULL, user_id UUID NOT NULL, weight DOUBLE PRECISION NOT NULL, date_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_196E77F5639666D6 ON "selectedProduct" (meal_id)');
        $this->addSql('CREATE INDEX IDX_196E77F522C1D6FB ON "selectedProduct" (food_product_id)');
        ...
        $this->addSql('COMMENT ON COLUMN "selectedProduct".food_product_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE "selectedProduct" ADD CONSTRAINT FK_196E77F522C1D6FB FOREIGN KEY (food_product_id) REFERENCES "foodProduct" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "selectedProduct" DROP CONSTRAINT FK_196E77F522C1D6FB');
